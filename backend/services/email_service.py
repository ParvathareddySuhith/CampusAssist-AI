...
- CampusAssist AI: The Support Team
"""
...
Welcome aboard! We are excited to have you join the CampusAssist AI platform - your personal assistant for all academic queries.
...
"""
            ...
            try:
                # Create email using standard library
                smtp_msg = MIMEText(email_body, 'plain', 'ascii')
                smtp_msg['Subject'] = "Welcome to CampusAssist AI!"
                smtp_msg['From'] = Config.MAIL_USERNAME
